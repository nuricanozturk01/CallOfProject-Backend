...
public class EducationUpdateDTO
{
    ...
    @Parameter(description = "Education ID")
    @NotNull
     ...
     * @param gpa         gpa
     */
    public EducationUpdateDTO(UUID userId, String schoolName, String department, String description, LocalDate startDate, LocalDate finishDate, boolean isContinue, double gpa)
    {
        this.userId = userId;
